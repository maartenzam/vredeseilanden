...
d3.csv("data/gi_10_13.csv", function(data) {
	...
	var labels = svg.selectAll("text")
		...
		.enter()
		.append("text")
		.text(function(d) {return d["GI2013"] + " $   " + d["Name"]; })
		.attr("class", function(d) {return d["Region"] + " " + d["Commodity" ] + " in " + d["Country"] + " label13"})
		.attr("x", xsecond + 5)
	...
	d3.selectAll("#textdata").selectAll("div")
		...
		.html(function(d) {return "<h3>" + d["Name"] + "</h3><p>From " + d["GI2010"] +" $ in 2010 to " + d["GI2013"] + " $ in 2013</p><p><em>" + d["Quote"] + "</em></p>"; })
		.style("visibility", "hidden");
